...
contextBridge.exposeInMainWorld('api', {
  ...
  // 8) Start tailing the demucs-log file
  startTailLog: () => {
    ipcRenderer.send('start-tail-log');
  },

  // 9) On every new appended line from demucs-log, callback
  ...
  // 10) Premiere extension installation (existing from previous steps)
